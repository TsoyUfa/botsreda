...
В `supabase/seed.sql`:
- 10 недель программы (`program_weeks`) — из [programma-obucheniya-8-nedel.md](programma-obucheniya-8-nedel.md).
- ДЗ для каждой недели — из [03-kriterii-zachyota-dz.md](03-kriterii-zachyota-dz.md), сводная таблица для seed.sql.
- 5 рангов — из [02-pravila-geymifikacii.md](02-pravila-geymifikacii.md).
